...
class CircularPercentIndicator extends StatefulWidget {
  ...
  ///widgets at the top of the circle
  final Widget? header;

  ///widgets at the bottom of the circle
  final Widget? footer;

  ///widgets inside the circle
  final Widget? center;
  ...
  /// set false if you don't want to preserve the state of the widgets
  ...
  /// Display a widgets indicator at the end of the progress. It only works when `animation` is true
